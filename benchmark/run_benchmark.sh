...
run "bgzip -c -f test.vcf > test.vcf.gz"
#run "bgzip -c -f -l9 test.vcf > test.vcf.l9.gz"
...
run "bgzip -c -f test.vcf.spvcf > test.vcf.spvcf.gz"
run "bgzip -c -f -l9 test.vcf.spvcf > test.vcf.spvcf.l9.gz"
